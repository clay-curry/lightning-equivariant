...
from e3nn import o3
from e3nn import nn as e3nn
from torch_scatter import scatter

from project.blocks.irreps_tools import irreps2gate
...
class TensorProductConvLayer(torch.nn.Module):
    def __init__(
        ...
        Implements a Tensor Field Network equivariant GNN layer for higher-order tensors, using the 
        e3nn library. Implementation adapted from: https://github.com/gcorso/DiffDock/
        ...
        Args:
            ...
            wt_irreps: (e3nn.o3.Irreps) Spherical harmonic irreps dimensions
        ...
        if gate:
            ...
            if irreps_gated.num_irreps == 0:
                self.gate = e3nn.Activation(out_irreps, acts=[torch.nn.functional.silu])
            else:
                self.gate = e3nn.Gate(
        ...
        self.batch_norm = e3nn.BatchNorm(out_irreps) if batch_norm else None
